...
fetch('http://localhost:3001/modal?unit=4&vicModalValue=true&deploymentModalValue=true&crewModalValue=true&medModalValue=true&weaponModalValue=true&verbose=true')
  .then(res => res.json())
  .then(data=> {
    let url = 'http://localhost:3001/modal?unit=4&vicModalValue=true&deploymentModalValue=true&crewModalValue=true&medModalValue=true&weaponModalValue=true&verbose=true'
    let fetchName = 'GET: MODAL'
    let vars = 'All params fully implemented \nrrequired query params: unit(number) \noptional query params: verbose(true/false as string), vicModalValue(true/false as string), deploymentModalValue(true/false as string), crewModalValue(true/false as string), medModalValue(true/false as string), weaponModalValue(true/false as string)'
    console.log(
      `${fetchName}\n${vars}\nURL:${url}\n`,
    )
    console.dir(data, { depth: null });
